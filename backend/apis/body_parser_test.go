 ...
 *   https://www.softnix.co.th/                      |
 * --------------------------------------------------+
 *
 * Copyright 2023 SOFTNIX and/or licensed to SOFTNIX under one
 * or more contributor license agreements. Licensed under the SOFTNIX License;
 */
